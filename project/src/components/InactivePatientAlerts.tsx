      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div className="space-y-3 max-h-96 overflow-y-auto">
          {items.map((item) => (
            <div
              key={item.customer.id}
              className="rounded-lg p-3 border border-gray-200 hover:shadow-md bg-gray-50"
            >
              <div className="flex flex-wrap items-center justify-between gap-1.5">
                <div>
                  <div className="text-base font-bold text-gray-900">{item.customer.name}</div>
                  <div className="text-xs text-gray-600">{item.customer.name_kana}</div>
                  <div className="flex flex-wrap gap-2 text-xs text-gray-700 mt-0.5">
